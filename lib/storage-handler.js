...
exports.upload = function(provider, req, res, options, cb) {
  ...
  form.parse(req, function(err, _fields, _files) {
    ...
    // Commented out by Michael Hayden from Made-Movement
    // We want to allow the use of this module even if no file was uploaded.
    // asking the developers of this module was fruitless because there was no response
    // for this issue
    // question url: https://github.com/strongloop/loopback-component-storage/issues/184
